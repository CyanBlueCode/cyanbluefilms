...
export const combatSportsDefaultData = {
  ...
  mainVideoSection: {
    ...
    subtitle: 'A glimpse at the high-quality tailored marketing hero videos we create for combat sports gyms like yours',
    thumbnail: '/images/film.jpg',
    videoUrl: 'https://www.youtube.com/embed/J0IItrdHQ2s',
  },
  benefitsSection: {
    title: 'Why Choose Us',
    subtitle: 'We don\'t just make videos, we create high-value tailored marketing assets that drive new members and set your fitness brand apart',
    cards: [
      {
        title: 'Content That Converts',
        description: 'We train in combat sports and understand fight culture from the inside. Our videos resonate with both casual fitness seekers and serious fighters alike, and turn viewers into paying members, not just likes.',
      },
      {
        title: 'Stand Out From The Competition',
        description: 'Generic social clips get lost in the scroll. Our professional videos make your gym look world-class. Tailored to your gym and shot on real cinema cameras, giving you a clear edge over competitors in a crowded market.',
      },
      {
        title: 'Max Reach From One Shoot',
        description: 'Every shoot is optimized for multiple platforms and formats in a single package, so you get weeks of content that works everywhere from IG reels to your website hero video without extra hassle.',
      },
      {
        title: 'Max Reach From One Shoot!!!',
      ...
      },
      {
        ...
        description: 'background image test test test test test test test test test test test test test test test test test test test test test test test. not sure if I like this...',
  ...
  packageHighlightsSection: {
    ...
    subtitle: 'Get a versatile main hero video and multiple platform-ready assets all in a single shoot day',
